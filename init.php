<?php
/**
 * Plugin Name: HYP Status Comanda
 * Plugin URI: https://github.com/hypericumimpex/hyp-status-comanda/
 * Description: <code><strong>HYP Status Comanda Personalizat</strong></code> vă permite să creați și să gestionați noi status-uri de comenzi personalizate. De exemplu, puteți să creați "în timpul expedierii" sau "expediate" înainte de a seta comenzile cu starea respectivă.
 * Version: 1.1.8
 * Author: Romeo C
